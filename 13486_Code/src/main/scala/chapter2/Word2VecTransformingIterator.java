...
public class Word2VecTransformingIterator implements DataSetIterator {
     ...
     */
    public Word2VecTransformingIterator(String dataDirectory, WordVectors wordVectors, int batchSize, int truncateLength, boolean train) throws IOException {
    ...
    public INDArray transformStringIntoFeatureVectorOfNumber(String reviewContents, int maxLength){
